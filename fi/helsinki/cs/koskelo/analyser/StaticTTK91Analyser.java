...
public class StaticTTK91Analyser extends CommonAnalyser {
	 ...
	 * -oliot. Rumaa, mutta pakko tehdä ennen varsinaisen
	 * analyse()-metodin käyntiinpotkaisemista (jotta mahdolliset
	 * aliluokat (ainakin FillinTTK91Analyser) voivat peittää
	 * peittää fetchExampleCoden, ja käyttää tämän luokan omaa
	 * analyse()-metodia. 
	 */
