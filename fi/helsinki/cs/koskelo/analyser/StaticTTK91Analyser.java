...
public class StaticTTK91Analyser extends CommonAnalyser {
  ...
  public Feedback analyse(String[] answer, String params) { // FIXME:
    ...
    // kesken
		...
		// taskOptionsin ennen super.analyse() kutsua. Eli t‰m‰ seuraava
		// pit‰isi siirt‰‰ jonnekin aikaisemmin. Testasin heitt‰‰ sen
		// registerCacheen ja kyll‰h‰h‰n se toimii, mutta ei kauhean siisti‰... 
		// Tom 10.12.2004
