...
public final class TTK91AnalyserExtraUtils {
	 ...
	 * vaikka piilosyˆtteill‰ ei olisikaan simuloitu. Julkiset/syˆtteettˆm‰t
	 * muisti ja symbolitaulu vertaillaan yhdess‰ kuten piilosyˆtteelliset.
	 *
	 * @param criteria Ei saa olla null
	 * @param studentPublicSymbolTable Opiskelijan julkisten syˆtteiden
	 * tai syˆtteetˆn symbolitaulu
	 * @param studentHiddenSymbolTable Opiskelijan piilosyˆtteiden
	 * symbolitaulu
	 *
	 * @param studentPublicMemoryLines Opiskelijan julkisten syˆtteiden
	 * muisti tai syˆtteetˆn muisti
	 * @param studentHiddenMemoryLines Opiskelijan piilosyˆtteiden muisti
	 */
